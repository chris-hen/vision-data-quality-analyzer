# -------------------------------------------------------------------------
# CNN PlotNeuralNet architecture visualization:
# -------------------------------------------------------------------------
#
# This script generates a LaTeX/TikZ visualization of the trained
# CNN architecture used for image degradation classification.
#
# The visualization is based on PlotNeuralNet-style layer macros.
#
# The workflow is:
#
# - Python writes the LaTeX/TikZ code into a .tex file
# - MiKTeX is used to compile the .tex file into a PDF
# - Inkscape is used afterwards to convert the PDF/SVG output
#   into a dashboard-friendly visualization format
#
# The original PlotNeuralNet box macros were modified and rebuilt
# for this project to create a visual presentation that better fits
# the dashboard and project documentation.
#
# Especially the Box macros were adapted so that individual faces,
# sides and edges of the 3D blocks can be shown or hidden separately.
# This makes it possible to create cleaner CNN blocks, activation bands,
# pooling blocks and dense/output layers with the exact visual style
# needed for this portfolio project.
# -------------------------------------------------------------------------
...
# output folder for generated visualization files
OUTPUT_DIR = PROJECT_ROOT / "results" / "visualizations"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# final generated LaTeX file
OUTPUT_TEX = OUTPUT_DIR / "cnn_plotneuralnet_portfolio.tex"
...
# raw LaTeX string used to generate the CNN architecture visualization
tex = r"""
...
def main():
    ...
    # write generated LaTeX code to output file
